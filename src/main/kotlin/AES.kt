fun main() {
    val message = "hello there my sexy motherfucker this is the secret code that no one will ever know because yes amazing and you are cute btw not you reading just my bubba is cute and maybe the kitty too."
    val maxColumns = 6
    ...
    println("Performing an AES on \"$message\"")
    for (entry in table) {
        println(entry.value)
    }
    println("\n")
